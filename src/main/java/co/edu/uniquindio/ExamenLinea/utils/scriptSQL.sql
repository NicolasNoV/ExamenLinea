...
INSERT INTO examenLinea.grupo (nombre, horario_id, plan_estudio_id, profesor_id, estado) VALUES ('Física 104', 1, 1, 2, 'ACTIVO');
...
INSERT INTO examenLinea.tema (nombre, estado) VALUES ('Historia', 'ACTIVO');
...
INSERT INTO examenLinea.banco_pregunta (estado, tema_id) VALUES ('ACTIVO', 3);
INSERT INTO examenLinea.banco_pregunta (estado, tema_id) VALUES ('ACTIVO', 3);
...
INSERT INTO examenLinea.pregunta (estado, porcentaje, pregunta, tiempo, tipo_pregunta) VALUES ('ACTIVO', 50.0, '¿Cuál es la capital de Francia?', '2021-01-01T12:00:00', 'SELECCION_MULTIPLE_UNICA_RESPUESTA');
INSERT INTO examenLinea.pregunta (estado, porcentaje, pregunta, tiempo, tipo_pregunta) VALUES ('ACTIVO', 55.0, '¿En qué año finalizó la Segunda Guerra Mundial?', '2021-01-01T12:00:00', 'FALSO_VERDADERO');
...
INSERT INTO examenLinea.dia_evaluacion (dia, estado, fecha, hora) VALUES ('2023-12-10', 'ACTIVO', '2023-12-10', STR_TO_DATE('10:00:00', '%H:%i:%s'));
...
INSERT INTO examenLinea.examen (cantidad_preguntas_banco, cantidad_preguntas_estudiante, categoria, descripcion, estado, estado_examen, nombre, tiempo_limite, tiempo_transcurrido, configuracion_id, dia_evaluacion_id, profesor_id) VALUES (5, 5, 'Física', 'Examen de física básica', 'ACTIVO', 'PENDIENTE', 'Física Básica', '2023-11-17 11:00:00', NULL, 1, 1, 2);
INSERT INTO examenLinea.examen (cantidad_preguntas_banco, cantidad_preguntas_estudiante, categoria, descripcion, estado, estado_examen, nombre, tiempo_limite, tiempo_transcurrido, configuracion_id, dia_evaluacion_id, profesor_id) VALUES (5, 5, 'historia', 'Examen de historia', 'ACTIVO', 'COMPLETADO', 'Historia', '2023-12-02 10:00:00', NULL, 1, 2, 3);
...
INSERT INTO examenLinea.respuesta (estado, respuesta, tipo_respuesta, pregunta_id) VALUES ('ACTIVO', 'París', 'SELECCION_MULTIPLE_UNICA_RESPUESTA', 3);
INSERT INTO examenLinea.respuesta (estado, respuesta, tipo_respuesta, pregunta_id) VALUES ('ACTIVO', '7 de mayo de 1945', 'FALSO_VERDADERO', 4);
...
INSERT INTO examenLinea.pregunta_examen (pregunta_id, examen_id) VALUES (2, 2);
INSERT INTO examenLinea.pregunta_examen (pregunta_id, examen_id) VALUES (3, 1);

INSERT INTO examenLinea.calificacion (estado, nota, estudiante_id, examen_id) VALUES ('ACTIVO', 85.0, 1, 1);
INSERT INTO examenLinea.calificacion (estado, nota, estudiante_id, examen_id) VALUES ('ACTIVO', 90.0, 2, 2);
INSERT INTO examenLinea.calificacion (estado, nota, estudiante_id, examen_id) VALUES ('ACTIVO', 70.0, 4, 2);
...
INSERT INTO examenLinea.estadistica_examen (estado, fecha, puntaje, tiempo_transcurrido, estudiante_id, examen_id) VALUES ('ACTIVO', '2023-11-17', 90.0, '2023-11-17 01:00:00', 2, 2);
...
INSERT INTO examenLinea.notificacion (estado, notificacion, calificacion_id, estudiante_id) VALUES ('ACTIVO', 'Su calificación en el examen de Física es 90', 2, 2);

INSERT INTO examenLinea.estudiante_examenes (estudiante_id, examenes_id) VALUES (1, 1);
INSERT INTO examenLinea.estudiante_examenes (estudiante_id, examenes_id) VALUES (2, 2);
